...
struct LocalizedStrings {
	...
	struct Settings {
		...
		static let decodeProsignDescription = NSLocalizedString("While this option is turned on (recomended), the application will automatically decode prosign based on the context of surronding Morse code.", comment: "A description on settings page, explaining what does Decode Prosign switch do.")
