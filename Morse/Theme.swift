...
enum Theme: String {
	...
	func primaryColor(withLevel level:ColorLevel) -> UIColor {
		...
		case .Medium: return self.colorPalates.primary.P200
		case .Dark: return self.colorPalates.primary.P300
		}
	}
	...
	func secondaryColor(withLevel level:ColorLevel) -> UIColor {
		...
		case .Medium: return self.colorPalates.secondary.P200
		case .Dark: return self.colorPalates.secondary.P300
		}
	}
}
